...
mqtt_username = "wael4v"  # Your Adafruit IO username
mqtt_password = "aio_jlMW50j8KNN6YaWd1XqQHfCW8IEx"  # Adafruit IO Key
mqtt_publish_topic = "wael4v/feeds/airfit"  # The MQTT topic for your Adafruit IO Feed
